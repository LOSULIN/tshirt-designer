...
const compactInputClass =
  "min-w-0 rounded border border-zinc-300 bg-white px-0.5 py-0 text-[10px] font-mono leading-4 text-zinc-900 tabular-nums disabled:cursor-not-allowed disabled:bg-zinc-100 disabled:text-zinc-500";
